...
public class TextComponent extends JComponent {
  ...
  public TextComponent(
      int fontSize, int maxLines, int maxCols, Color foregroundColor, Color backgroundColor) {
  ...
  private void printChar(
      Graphics g, int line, int pos, char chr, Color foreground, Color background) {
